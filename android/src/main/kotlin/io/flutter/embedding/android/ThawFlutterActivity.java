 ...
 *
 * <p>{@code ThawFlutterActivity} is the simplest and most direct way to integrate Flutter within an
 * Android app.
 *
 * <p><strong>ThawFlutterActivity responsibilities</strong>
 *
 * <p>{@code ThawFlutterActivity} maintains the following responsibilities:
 *
 * <ul>
 ...
 * the entrypoint that a {@code ThawFlutterActivity} executes, subclass {@code ThawFlutterActivity} and
 ...
 * of {@code ThawFlutterActivity} by overriding their respective methods:
 *
 * <ul>
 ...
 *
 * <p>{@code ThawFlutterActivity} can be used with a cached {@link FlutterEngine} instead of creating a
 * new one. Use {@link #withCachedEngine(String)} to build a {@code ThawFlutterActivity} {@code Intent}
 ...
 *
 * <ul>
 *   <li>When {@code ThawFlutterActivity} is the first {@code Activity} displayed by the app, because
 ...
 * }</pre>
 *
 * <p><strong>Alternatives to ThawFlutterActivity</strong>
 *
 ...
 *
 * <p>{@code ThawFlutterActivity} supports the display of an Android "launch screen" as well as a
 * Flutter-specific "splash screen". The launch screen is displayed while the Android application
 * loads. It is only applicable if {@code ThawFlutterActivity} is the first {@code Activity} displayed
 ...
 *
 * <p>In the AndroidManifest.xml, set the theme of {@code ThawFlutterActivity} to the defined launch
 * theme. In the metadata section for {@code ThawFlutterActivity}, defined the following reference to
 * your normal theme:
 *
 ...
 * initialization, subclass {@code ThawFlutterActivity} and override {@link #provideSplashScreen()}. See
 ...
 * the following metadata in AndroidManifest.xml for this {@code ThawFlutterActivity}:
 *
 ...
 * is similar to {@code ThawFlutterActivity} but it extends {@code FragmentActivity}. You should use
 * {@code ThawFlutterActivity}, if possible, but if you need a {@code FragmentActivity} then you should
...
public class ThawFlutterActivity extends Activity
        implements ThawFlutterActivityAndFragmentDelegate.Host, LifecycleOwner {
    private static final String TAG = "ThawFlutterActivity";

    /**
     * Creates an {@link Intent} that launches a {@code ThawFlutterActivity}, which creates a {@link
     ...
     * launch a {@code ThawFlutterActivity} that internally creates a new {@link FlutterEngine} using the
     * desired Dart entrypoint, initial route, etc.
     */
    @NonNull
    public static NewEngineIntentBuilder withNewEngine() {
        return new NewEngineIntentBuilder(ThawFlutterActivity.class);
    }

    /**
     * Builder to create an {@code Intent} that launches a {@code ThawFlutterActivity} with a new {@link
     * FlutterEngine} and the desired configuration.
     */
    public static class NewEngineIntentBuilder {
        private final Class<? extends ThawFlutterActivity> activityClass;
        private String initialRoute = DEFAULT_INITIAL_ROUTE;
        private String backgroundMode = DEFAULT_BACKGROUND_MODE;

        /**
         * Constructor that allows this {@code NewEngineIntentBuilder} to be used by subclasses of
         * {@code ThawFlutterActivity}.
         *
         * <p>Subclasses of {@code ThawFlutterActivity} should provide their own static version of {@link
         * #withNewEngine()}, which returns an instance of {@code NewEngineIntentBuilder} constructed
         * with a {@code Class} reference to the {@code ThawFlutterActivity} subclass, e.g.:
         *
         * <p>{@code return new NewEngineIntentBuilder(MyThawFlutterActivity.class); }
         */
        public NewEngineIntentBuilder(@NonNull Class<? extends ThawFlutterActivity> activityClass) {
        ...
        /**
         * The mode of {@code ThawFlutterActivity}'s background, either {@link BackgroundMode#opaque} or
         ...
         * {@link FlutterView} of this {@code ThawFlutterActivity} to be configured with a {@link
         ...
         * being implemented.
         *
         * <p>A {@code ThawFlutterActivity} that is configured with a background mode of {@link
        ...
        /**
         * Creates and returns an {@link Intent} that will launch a {@code ThawFlutterActivity} with the
     ...
     * to launch a {@code ThawFlutterActivity} that internally uses an existing {@link FlutterEngine} that
     * is cached in {@link io.flutter.embedding.engine.FlutterEngineCache}.
     */
    public static CachedEngineIntentBuilder withCachedEngine(@NonNull String cachedEngineId) {
        return new CachedEngineIntentBuilder(ThawFlutterActivity.class, cachedEngineId);
    }

    /**
     * Builder to create an {@code Intent} that launches a {@code ThawFlutterActivity} with an existing
    ...
    public static class CachedEngineIntentBuilder {
         ...
         * constructed with a {@code Class} reference to the {@code ThawFlutterActivity} subclass, e.g.:
         *
         * <p>{@code return new CachedEngineIntentBuilder(MyThawFlutterActivity.class, engineId); }
         */
        public CachedEngineIntentBuilder(
                @NonNull Class<? extends ThawFlutterActivity> activityClass, @NonNull String engineId) {
            this.activityClass = activityClass;
         ...
         * cache when this {@code ThawFlutterActivity} is destroyed.
         *
    ...
    // ThawFlutterActivity and FlutterFragment. See the ThawFlutterActivityAndFragmentDelegate
    // implementation for details about why it exists.
    @VisibleForTesting protected ThawFlutterActivityAndFragmentDelegate delegate;

    @NonNull private LifecycleRegistry lifecycle;

    public ThawFlutterActivity() {
     ...
     *
     * <p>The testing infrastructure should be upgraded to make ThawFlutterActivity tests easy to write
     ...
     *   <li>In the AndroidManifest.xml, set the theme of your {@code ThawFlutterActivity} to your launch
     *       theme.
     *   <li>Add a {@code <meta-data>} property to your {@code ThawFlutterActivity} with a name of
    ...
    private void switchLaunchThemeForNormalTheme() {
        try {
            ...
            Log.e(
                    TAG,
                    "Could not read meta-data for ThawFlutterActivity. Using the launch theme as normal theme.");
        }
    }
     ...
     * ThawFlutterActivityAndFragmentDelegate} to obtain a {@code Context} reference as needed.
     */
    @Override
    @NonNull
    ...
    /**
     * {@link ThawFlutterActivityAndFragmentDelegate.Host} method that is used by {@link
     * ThawFlutterActivityAndFragmentDelegate} to obtain an {@code Activity} reference as needed. This
    ...
    /**
     * {@link ThawFlutterActivityAndFragmentDelegate.Host} method that is used by {@link
     * ThawFlutterActivityAndFragmentDelegate} to obtain a {@code Lifecycle} reference as needed. This
     ...
     * ThawFlutterActivity}, or {@code null} if this {@code ThawFlutterActivity} does not want to use a cached
     * {@link FlutterEngine}.
     */
    @Override
    @Nullable
    ...
    /**
     * Returns false if the {@link FlutterEngine} backing this {@code ThawFlutterActivity} should outlive
     * this {@code ThawFlutterActivity}, or true to be destroyed when the {@code ThawFlutterActivity} is
     * destroyed.
     *
     * <p>The default value is {@code true} in cases where {@code ThawFlutterActivity} created its own
     ...
     * snapshots.
     *
     * <p>When this {@code ThawFlutterActivity} is run by Flutter tooling and a data String is included in
    ...
    /**
     * {@link ThawFlutterActivityAndFragmentDelegate.Host} method that is used by {@link
     * ThawFlutterActivityAndFragmentDelegate} to obtain the desired {@link RenderMode} that should be
    ...
    /**
     * {@link ThawFlutterActivityAndFragmentDelegate.Host} method that is used by {@link
     * ThawFlutterActivityAndFragmentDelegate} to obtain the desired {@link TransparencyMode} that should
     ...
     * ThawFlutterActivity} is being subclassed to utilize a custom and/or cached {@link FlutterEngine}.
     *
     ...
     * this {@code ThawFlutterActivity} will connect its {@link FlutterEngine} to itself, along with any
     ...
     * {@code ThawFlutterActivity} will not automatically manage the connection between its {@link
     ...
     * outlive this {@code ThawFlutterActivity} so that it can be used later in a different {@code
     * Activity}. To accomplish this, the {@link FlutterEngine} may need to be disconnected from this
     * {@code FluttterActivity} at an unusual time, preventing this {@code ThawFlutterActivity} from
