 ...
 *
 * <p>{@code ThawFlutterFragmentActivity} exists because there are some Android APIs in the ecosystem
...
// FlutterActivity, too.
public class ThawFlutterFragmentActivity extends FragmentActivity
        implements SplashScreenProvider, FlutterEngineProvider, FlutterEngineConfigurator {
    private static final String TAG = "ThawFlutterFragmentActivity";
    ...
    /**
     * Creates an {@link Intent} that launches a {@code ThawFlutterFragmentActivity}, which executes a
    ...
    /**
     * Creates an {@link ThawFlutterFragmentActivity.NewEngineIntentBuilder}, which can be used to
     * configure an {@link Intent} to launch a {@code ThawFlutterFragmentActivity} that internally creates
     * a new {@link FlutterEngine} using the desired Dart entrypoint, initial route, etc.
     */
    @NonNull
    public static NewEngineIntentBuilder withNewEngine() {
        return new NewEngineIntentBuilder(ThawFlutterFragmentActivity.class);
    }

    /**
     * Builder to create an {@code Intent} that launches a {@code ThawFlutterFragmentActivity} with a new
     * {@link FlutterEngine} and the desired configuration.
     */
    public static class NewEngineIntentBuilder {
        private final Class<? extends ThawFlutterFragmentActivity> activityClass;
        private String initialRoute = DEFAULT_INITIAL_ROUTE;
        private String backgroundMode = DEFAULT_BACKGROUND_MODE;

        /**
         * Constructor that allows this {@code NewEngineIntentBuilder} to be used by subclasses of
         * {@code ThawFlutterFragmentActivity}.
         *
         * <p>Subclasses of {@code ThawFlutterFragmentActivity} should provide their own static version of
         * {@link #withNewEngine()}, which returns an instance of {@code NewEngineIntentBuilder}
         * constructed with a {@code Class} reference to the {@code ThawFlutterFragmentActivity} subclass,
         * e.g.:
         *
         * <p>{@code return new NewEngineIntentBuilder(MyFlutterActivity.class); }
         */
        public NewEngineIntentBuilder(@NonNull Class<? extends ThawFlutterFragmentActivity> activityClass) {
            this.activityClass = activityClass;
        }

        /**
         * The initial route that a Flutter app will render in this {@code ThawFlutterFragmentActivity},
         * defaults to "/".
         */
        @NonNull
        ...
        /**
         * The mode of {@code ThawFlutterFragmentActivity}'s background, either {@link
         ...
         * {@link FlutterView} of this {@code ThawFlutterFragmentActivity} to be configured with a {@link
         ...
         * being implemented.
         *
         * <p>A {@code ThawFlutterFragmentActivity} that is configured with a background mode of {@link
        ...
        /**
         * Creates and returns an {@link Intent} that will launch a {@code ThawFlutterFragmentActivity} with
     ...
     * to launch a {@code ThawFlutterFragmentActivity} that internally uses an existing {@link
     * FlutterEngine} that is cached in {@link io.flutter.embedding.engine.FlutterEngineCache}.
     */
    @NonNull
    public static CachedEngineIntentBuilder withCachedEngine(@NonNull String cachedEngineId) {
        return new CachedEngineIntentBuilder(ThawFlutterFragmentActivity.class, cachedEngineId);
    }

    /**
     * Builder to create an {@code Intent} that launches a {@code ThawFlutterFragmentActivity} with an
    ...
    public static class CachedEngineIntentBuilder {
        ...
        public CachedEngineIntentBuilder(
                @NonNull Class<? extends ThawFlutterFragmentActivity> activityClass, @NonNull String engineId) {
            this.activityClass = activityClass;
         ...
         * cache when this {@code ThawFlutterFragmentActivity} is destroyed.
         *
    ...
    @Nullable private ThawFlutterFragment flutterFragment;
     ...
     *   <li>In the AndroidManifest.xml, set the theme of your {@code ThawFlutterFragmentActivity} to your
     *       launch theme.
     *   <li>Add a {@code <meta-data>} property to your {@code ThawFlutterFragmentActivity} with a name of
    ...
    private void switchLaunchThemeForNormalTheme() {
        try {
            ...
            Log.e(
                    TAG,
                    "Could not read meta-data for ThawFlutterFragmentActivity. Using the launch theme as normal theme.");
        }
    }
     ...
     * the {@link FlutterFragment} displayed by this {@code ThawFlutterFragmentActivity}.
     *
     * <p>
     *
    ...
    /**
     * Ensure that a {@link FlutterFragment} is attached to this {@code ThawFlutterFragmentActivity}.
     *
     * <p>If no {@link FlutterFragment} exists in this {@code ThawFlutterFragmentActivity}, then a {@link
     * FlutterFragment} is created and added. If a {@link FlutterFragment} does exist in this {@code
     * ThawFlutterFragmentActivity}, then a reference to that {@link FlutterFragment} is retained in
     * {@code #flutterFragment}.
     */
    private void ensureFlutterFragmentCreated() {
        FragmentManager fragmentManager = getSupportFragmentManager();
        flutterFragment = (ThawFlutterFragment) fragmentManager.findFragmentByTag(TAG_FLUTTER_FRAGMENT);
    ...
    /**
     * Creates the instance of the {@link FlutterFragment} that this {@code ThawFlutterFragmentActivity}
     * displays.
     *
     * <p>Subclasses may override this method to return a specialization of {@link FlutterFragment}.
     */
    @NonNull
    protected ThawFlutterFragment createFlutterFragment() {
        ...
        if (getCachedEngineId() != null) {
            ...
            return ThawFlutterFragment.withCachedEngine(getCachedEngineId())
            ...
            return ThawFlutterFragment.withNewEngine()
    ...
    /**
     * Returns false if the {@link FlutterEngine} backing this {@code ThawFlutterFragmentActivity} should
     * outlive this {@code ThawFlutterFragmentActivity}, or true to be destroyed when the {@code
     * ThawFlutterFragmentActivity} is destroyed.
     *
     * <p>The default value is {@code true} in cases where {@code ThawFlutterFragmentActivity} created its
     ...
     * ThawFlutterFragmentActivity} is being subclassed to utilize a custom and/or cached {@link
     * FlutterEngine}.
     *
     ...
     * snapshots.
     *
     * <p>When this {@code ThawFlutterFragmentActivity} is run by Flutter tooling and a data String is
     ...
     * definition for this {@code ThawFlutterFragmentActivity}.
     *
     ...
     * ThawFlutterFragmentActivity}, or {@code null} if this {@code ThawFlutterFragmentActivity} does not want
     ...
     * ThawFlutterFragmentActivity}.
     *
     * <p>That is, {@link RenderMode#surface} if {@link ThawFlutterFragmentActivity#getBackgroundMode()}
