 ...
 * behavior.</strong>
 */
/* package */ final class ThawFlutterActivityAndFragmentDelegate implements ExclusiveAppComponent<Activity> {
    private static final String TAG = "ThawFlutterActivityAndFragmentDelegate";
    private static final String FRAMEWORK_RESTORATION_BUNDLE_KEY = "framework";
    private static final String PLUGINS_RESTORATION_BUNDLE_KEY = "plugins";

    // The FlutterActivity or FlutterFragment that is delegating most of its calls
    // to this ThawFlutterActivityAndFragmentDelegate.
    ...
    ThawFlutterActivityAndFragmentDelegate(@NonNull Host host) {
        this.host = host;
    }

    /**
     * Disconnects this {@code ThawFlutterActivityAndFragmentDelegate} from its host {@code Activity} or
     * {@code Fragment}.
     *
     * <p>No further method invocations may occur on this {@code ThawFlutterActivityAndFragmentDelegate}
    ...
    void onAttach(@NonNull Context context) {
        ...
        if (host.shouldAttachEngineToActivity()) {
            String cacheEngineId = host.getCachedEngineId();
            if (cacheEngineId != null) {
                ExclusiveAppComponentRegistry.getInstance().attachToActivity(cacheEngineId, this);
            }
    ...
    void onDetach() {
        ...
        if (host.shouldAttachEngineToActivity()) {
            ...
            String cacheEngineId = host.getCachedEngineId();
            if (cacheEngineId != null) {
                ExclusiveAppComponentRegistry.getInstance().detachFromActivity(cacheEngineId);
            }
        }
    ...
    private void ensureAlive() {
        if (host == null) {
            throw new IllegalStateException(
                    "Cannot execute method on a destroyed ThawFlutterActivityAndFragmentDelegate.");
        }
    }
    ...
    public Activity getAppComponent() {
        ...
        if (activity == null) {
            throw new AssertionError(
                    "ThawFlutterActivityAndFragmentDelegate's getAppComponent should only "
...
//        }
     ...
     * ThawFlutterActivityAndFragmentDelegate}.
     */
